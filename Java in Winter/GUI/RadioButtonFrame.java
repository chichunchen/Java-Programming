...
public class RadioButtonFrame extends JFrame {
  ...
  public RadioButtonFrame() {
    ...
    //create font objects
    plainFont = new Font( "Sherif", Font.PLAIN, 14 );
    boldFont = new Font( "Sherif", Font.BOLD, 14 );
    italicFont = new Font( "Sherif", Font.ITALIC, 14 );
    boldItalicFont = new Font( "Sherif", Font.ITALIC + Font.BOLD, 14 );
